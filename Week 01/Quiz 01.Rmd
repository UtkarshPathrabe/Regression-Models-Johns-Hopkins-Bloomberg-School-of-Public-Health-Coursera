...
Question 10
-----------  
Let the slope having fit Y as the outcome
and X as the predictor be denoted as $\(\beta_1 \)$. Let the slope from fitting X as the outcome and Y as the predictor be denoted as $\(\gamma_1 \)$. Suppose that you divide $\(\beta_1 \)$ by $\(\gamma_1 \)$, in other words consider $\(\beta_1 / \gamma_1\)$. What is this ratio always equal to?  
